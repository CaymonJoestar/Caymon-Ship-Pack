...
public class csp_cetanweaponSwap extends BaseHullMod {
    ...
    {
        RIGHT_SELECTOR.put(0, "csp_Buster_Rifle");
        RIGHT_SELECTOR.put(1, "csp_Mark9arm");
        RIGHT_SELECTOR.put(2, "csp_cetanmirv");
    }
    ...
    {
		SWITCH_TO_RIGHT.put("csp_Buster_Rifle",1);
        SWITCH_TO_RIGHT.put("csp_Mark9arm",2);
        SWITCH_TO_RIGHT.put("csp_cetanmirv",0);
    }
    ...
    {
        RIGHTSWITCH.put(0,"csp_selector_buster");
        RIGHTSWITCH.put(1,"csp_selector_mark9");
        RIGHTSWITCH.put(2,"csp_selector_mirv");
    }    
    
    private final String leftslotID = "WS0004";
